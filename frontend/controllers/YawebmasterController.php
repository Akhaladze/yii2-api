 ...
 * Site controller
 */
class YawebmasterController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'signup', 'auth','test'],
                'rules' => [
                    [
                        'actions' => ['logout', 'signup','auth','test'],
                        'allow' => true,
                        'roles' => ['?'],
                    ],
                    [
